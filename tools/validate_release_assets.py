"""Static release-asset validation for the EfficientNet-B0 image-classification DIMER pipeline.
...
EXPECTED_MODEL_ID = "timm/efficientnet_b0.ra_in1k"
...
EXPECTED_OUTPUTS = (
    "efficientnet_classification_input_manifest.json",
    "efficientnet_classification_evaluation_report.json",
    "efficientnet_classification_result.json",
    "efficientnet_classification_predictions.csv",
    "efficientnet_adapter.safetensors",
)
...
EXTERNAL_WEIGHT_BYTES: dict[int, str] = {
    21441905: "upstream pytorch_model.bin (pickle checkpoint at the same Hub revision; not staged, not loaded)",
