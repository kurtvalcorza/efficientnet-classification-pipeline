...
The upstream snapshot is pinned to `1b5383e5f79cc0f7fc067e372f8f26a5fa73f26a` and the notebook is regenerated with that revision and manifest, so it can run; no execution is recorded yet.
